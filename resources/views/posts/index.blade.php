...
<head>
    ...
    <title>Noticias - Filament Practica</title>
            ...
            @forelse ($posts as $post)
                <article class="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col hover:shadow-2xl hover:-translate-y-1 transition duration-300">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <a href="{{ route('categories.show', $post->category_id) }}" class="inline-block self-start text-xs font-semibold text-indigo-600 bg-indigo-50 rounded-full px-3 py-1 mb-3 hover:bg-indigo-100 transition">
